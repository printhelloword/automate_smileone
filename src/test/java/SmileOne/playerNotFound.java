...
//            while(true){
//                try{
//            WebElement mlbbMenu = new WebDriverWait(driver, 15)
//                    .until(ExpectedConditions.elementToBeClickable(By.cssSelector(".listol1 > .list-li:nth-child(3) .imgicon")));
//            mlbbMenu.click();
...
//                    driver.findElement(By.id("puseid")).sendKeys("126606687");
                    driver.findElement(By.id("puseid")).sendKeys("122222222");
...
//            logger.log(Level.INFO, "/*-------------PURCHASE PROCESS FINISHED---------------*/");
    ...
    private static boolean isAlertExist(){
        try
        {

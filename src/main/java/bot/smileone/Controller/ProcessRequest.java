...
public class ProcessRequest {
    ...
    public static ProcessRequest ofRequest(Request request) {
        return new ProcessRequest(request.getTrxId(), request.getPlayerId(), request.getDenom());
    }

    public ProcessRequest(String trxId, String playerId, String denom) {
        this.trxId = trxId;
    ...
    public ResponsePojo getResponsePojo() {
        ...
        printResponseLogAndSaveOutbox(new JSONObject(responsePojo));
    ...
    private void printResponseLogAndSaveOutbox(JSONObject jsonObject) {
